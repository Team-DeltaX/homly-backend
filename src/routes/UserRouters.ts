...
import { reviewSentiment,allEmployees, userRegistration, emailVerification, userLogin, forgetPasswordDetails, otpVerification, resetPassword } from "../controllers/UserController";
...
homly_user.post("/review",reviewSentiment);
