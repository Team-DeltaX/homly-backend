...
import { testSMS,allEmployees, userRegistration, emailVerification, userLogin, forgetPasswordDetails, otpVerification, resetPassword } from "../controllers/UserController";
