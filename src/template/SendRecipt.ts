const SendReciptEmail = (employeeName: string, holidayHome: string, reservationNumber: any, checkinDate: Date, checkoutDate: Date, maxAdults: string, maxChildren: string, rooms: string, halls: string, roomPrice: string, hallPrice: string, TotalPrice: string) => {
    return (
        ...
        * For more information, visit https://tabular.email
        ...
        <body id="body" class="t188" style="min-width:100%;Margin:0px;padding:0px;background-color:#FFFFFF;"><div class="t187" style="background-color:#FFFFFF;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" align="center"><tr><td class="t186" style="font-size:0;line-height:0;mso-line-height-rule:exactly;background-color:#FFFFFF;" valign="top" align="center">
        <!--[if mso]>
        ...
        <span class="t133" style="display:block;margin:0;Margin:0;font-family:Albert Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:44px;font-weight:800;font-style:normal;font-size:12px;text-decoration:none;text-transform:uppercase;letter-spacing:2.4px;direction:ltr;color:#F8F8F8;text-align:center;mso-line-height-rule:exactly;mso-text-raise:10px;"><a class="t52" href="http://localhost:3000/myProfile" style="margin:0;Margin:0;font-weight:400;font-style:normal;text-decoration:none;direction:ltr;color:#ffffff;mso-line-height-rule:exactly;" target="_blank">Pay Now</a></span>
        </td></tr></table></td>
        </tr></table>
        </td></tr><tr><td>
