const BlacklistRemoveEmail =()=>{
    ...
    * For more information, visit https://tabular.email
    ...
    <!--[if !mso]><!--><td class="t15" style="width:183px;padding:0 15px 0 0;">
    <!--<![endif]-->
    <!--[if mso]><td class="t15" style="width:198px;padding:0 15px 0 0;"><![endif]-->
    <div style="font-size:0px;"><img class="t21" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="183" height="49.96875" alt="" src="https://drive.google.com/thumbnail?id=1A-WuiaOpfKXcAqZjIVZVNH0VEkzWMxI2&sz=w1000"/></div></td>
    </tr></table>
    ...
    <p class="t41" style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Albert Sans';line-height:21px;font-weight:400;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;letter-spacing:-0.64px;direction:ltr;color:#333333;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">We&#39;re <span class="t42" style="margin:0;Margin:0;mso-line-height-rule:exactly;">pleased </span>to inform you that, we have decided to remove your name from the blacklist on the Homly Holiday Home Booking System. You are now reinstated and able to access our services.</p></td>
    </tr></table>
    </td></tr></table></td>
    </tr></table>
...
export default BlacklistRemoveEmail;